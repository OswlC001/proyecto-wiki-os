...
public abstract class AbstractController<T> implements Serializable {
     ...
     * @return a collection of Entity items returned by the data layer
     */
    public T findObj(Object codigo) {
        T obj = ejbFacade.find(codigo);
        return obj;
    }
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/AppBundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/AppBundle").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/AppBundle").getString(itemClass.getSimpleName() + "Deleted");
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/AppBundle").getString("PersistenceErrorOccured"));
            }
        }
    }
